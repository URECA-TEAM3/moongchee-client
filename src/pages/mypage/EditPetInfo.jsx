    ...
    <div className="flex flex-col items-center bg-white h-full">
      ...
      <div className="flex flex-col w-full items-center max-w-md">
        ...
        <div className="flex justify-between p-5 w-full">
          <button onClick={handleDelete} className="py-2 bg-delete text-white rounded-lg w-48">
            삭제하기
          </button>
          <button
            onClick={() => {
            ...
            className="py-2 bg-primary rounded-lg w-48 text-white"
          >
            저장
          </button>
        </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg text-center w-80 h-auto p-6">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button onClick={confirmDelete} className="px-12 py-2 bg-delete text-white rounded-lg">
                  확인
                </button>
              </div>
            </div>
        ...
        {isDeletedModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg text-center w-80 h-auto p-6">
              ...
              <button onClick={handleCloseDeletedModal} className="px-12 py-2 bg-primary text-white rounded-lg">
                확인
              </button>
            </div>
          </div>
        ...
        {isSavedConfirmModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg text-center w-80 h-auto p-6">
              ...
              <div className="flex justify-center space-x-4">
                <button onClick={closeConfirmModal} className="px-12 py-2 bg-divider text-gray-500 rounded-lg">
                  취소
                </button>
